...
typedef struct
{
	int IdAfiliado, IdadeAfiliado;
	char NomeAfiliado[50], Endereco[50];
} Afiliado;
...
void MenuCadastroAfiliado()
{
	...
	do
	{
		...
		printf("|%*s|\n", 118, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                  MENU DE CADASTRO DO AFILIADO                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-CADASTRAR NOVO AFILIADO     | 2-MOSTRAR TODOS OS AFILIADOS  |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-EDITAR UM AFILIADO          | 4-EXCLUIR UM AFILIADO         |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                0-VOLTAR PARA MENU DE CADASTRO                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
		printf("|%*s|\n", 118, "");
		printf("|%*s|\n", 118, "");
...
void MenuCadastroLivro()
{
	...
	do
	{
		...
		printf("|%*s|\n", 118, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                  MENU DE CADASTRO DO LIVRO                    |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-CADASTRAR NOVO LIVRO        | 2-MOSTRAR TODOS OS LIVROS     |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-EDITAR UM LIVRO             | 4-EXCLUIR UM LIVRO            |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                0-VOLTAR PARA MENU DE CADASTRO                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
...
void MenuCadastroStatusLivro()
{
	...
	do
	{
		...
		printf("|%*s|\n", 118, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                MENU DE CADASTRO DO STATUS DO LIVRO            |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-CADASTRAR NOVO STATUS       | 2-MOSTRAR TODOS OS STATUS     |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-EDITAR UM STATUS            | 4-EXCLUIR UM STATUS           |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                0-VOLTAR PARA MENU DE CADASTRO                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
...
void MenuCadastroCategoriaLivro()
{
	...
	do
	{
		...
		printf("|%*s|\n", 118, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|             MENU DE CADASTRO DA CATEGORIA DO LIVRO            |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-CADASTRAR NOVA CATEGORIA    | 2-MOSTRAR TODAS AS CATEGORIAS |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-EDITAR UMA CATEGORIA        | 4-EXCLUIR UMA CATEGORIA       |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                0-VOLTAR PARA MENU DE CADASTRO                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
...
void MenuCadastroInventario()
{
	...
	do
	{
		...
		printf("|%*s|\n", 118, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                      MENU DE INVENT%cRIO                       |%*s|\n", 27, "", 181, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-NOVO INVENT%cRIO             | 2-MOSTRAR TODAS OS INVENT%cRIOS|%*s|\n", 27, "", 181, 181, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-EDITAR UM INVENT%cRIO        | 4-EXCLUIR UM INVENT%cRIO       |%*s|\n", 27, "", 181, 181, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                  0-VOLTAR PARA MENU PRINCIPAL                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
		printf("|%*s|\n", 118, "");
		printf("|%*s|\n", 118, "");
...
void MenuCadastroEmprestimoDevolucao()
{
	...
	do
	{
		...
		printf("|%*s|\n", 118, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                  MENU DE EMPR%cSTIMO OU DEVOLU%c%cO              |%*s|\n", 27, "", 144, 128, 199, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-EMPR%cSTIMOS E DEVOLU%c%cES    | 2-MOSTRAR TODAS OS MOVIMENTOS |%*s|\n", 27, "", 144, 128, 229, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-EDITAR UM MOVIMENTO         | 4-EXCLUIR UM MOVIMENTO        |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                  0-VOLTAR PARA MENU PRINCIPAL                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
...
void MenuImpressao()
{
	...
	do
	{
		...
		printf("|%*s|\n", 118, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                       MENU DE IMPRESS%cO                       |%*s|\n", 27, "", 199, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-AFILIADO                    | 2-LIVRO                       |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-STATUS LIVRO                | 4-CATEGORIA LIVRO             |%*s|\n", 27, "", 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 5-EMPR%cSTIMOS E DEVOLU%c%cO     | 6-INVENT%cRIO                  |%*s|\n", 27, "", 144, 128, 199, 181, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                  0-VOLTAR PARA MENU PRINCIPAL                 |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
...
int main()
{
	...
	do
	{
		...
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 1-CADASTRO                    | 2-INVENT%cRIO                  |%*s|\n", 27, "", 181, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s| 3-EMPR%cSTIMOS E DEVOLU%c%cES    | 4-IMPRESS%cO                   |%*s|\n", 27, "", 144, 128, 229, 199, 26, "");
		printf("|%*s+-------------------------------+-------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|                            0-SAIR                             |%*s|\n", 27, "", 26, "");
		printf("|%*s+---------------------------------------------------------------+%*s|\n", 27, "", 26, "");
		printf("|%*s|\n", 118, "");
